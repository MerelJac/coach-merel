      ...
      <div className="exerciseDiv">
        <section className="row">
          ...
          <div className="exercise-text">
            <h2 max={oneRepMaxSet} className="bold">{props.title}</h2>
          </div>
          <div>
            <input className="text-center w-[60px] weight" placeholder="lbs"></input>
            <input className="text-center w-[60px] reps" placeholder="reps"></input>
          </div>
